...
def sendEmail(gifter,gifterEmail,giftee,gifteeEmail):
    ...
    **************************************************************************
    ...
    Secret Santa list generated by the Ultimate Secret Santa App from theUltimateLabs.com""" % (giftee)
    message.send()
...
class MainHandler(webapp2.RequestHandler):
    ...
    def put(self,path):
        ...
        if path == 'submit':
            ...
            restrictWithinFamily = self.request.get('restrictWithinFamily') == 'True'
            noCycles = self.request.get('noCycles') == 'True'
